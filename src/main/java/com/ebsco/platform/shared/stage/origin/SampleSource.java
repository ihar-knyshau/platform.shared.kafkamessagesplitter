 ...
 */
package com.ebsco.platform.shared.stage.origin;

import com.ebsco.platform.shared.Runner;
...
public abstract class SampleSource  extends BasePushSource {
  ...
  private void initThread(){
    ...
    thread = new Thread(() -> {
      Consumer<byte[], byte[]> consumer = KafkaFactory.createConsumer("quickstart.cloudera:9092", "test35");
